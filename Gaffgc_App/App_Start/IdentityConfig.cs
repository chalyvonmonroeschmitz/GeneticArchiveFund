...
namespace Gaffgc_App
{
    ...
    public class UserManager : UserManager<Member>
    {
        public UserManager(IUserStore<Member> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new UserManager(new UserStore<Member>(context.Get<GaffgcDBContext>()));
